document.addEventListener('DOMContentLoaded', function () {
  ...
  const translations = {
    zh: {
      ...
      "portfolio-item3-title": "AI 量化交易系統 (LSTM)",
      "portfolio-item3-desc": "基於 PyTorch LSTM 的量化交易系統。在樣本外測試中實現了 +483% 的總回報 (CAGR 79.9%)。",
      "portfolio-item4-title": "DawnForge AI",
      "portfolio-item4-desc": "一站式 AI 模型聚合平台，無縫整合 ChatGPT、Gemini、Claude、Grok 與 DeepSeek。讓用戶在單一介面即可使用所有頂尖模型。",
      "portfolio-view-code": "GitHub 原始碼",
      "portfolio-view-site": "訪問網站",
      "contact-title": "聯繫我",
    ...
    en: {
      ...
      "portfolio-item3-title": "AI Quantitative Trading System (LSTM)",
      "portfolio-item3-desc": "A quantitative trading system based on PyTorch LSTM. It achieved a total return of +483% (CAGR 79.9%) in out-of-sample testing.",
      "portfolio-item4-title": "DawnForge AI",
      "portfolio-item4-desc": "A one-stop AI model aggregation platform that seamlessly integrates ChatGPT, Gemini, Claude, Grok, and DeepSeek. It allows users to access all top-tier models from a single interface.",
      "portfolio-view-code": "View Code on GitHub",
      "portfolio-view-site": "Visit the website",
